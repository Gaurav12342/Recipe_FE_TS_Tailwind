          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="flex flex-col max-w-3xl ml-48 -mr-32 md:mx-auto mt-1 md:mt-32 rounded-xl overflow-hidden bg-red-100 md:flex md:flex-row">
              ...
              <div className="w-full md:mt-10 md:w-1/2">
                ...
                <div className="flex flex-row justify-start space-x-5 mt-8 ml-5">
                  <button
                    className="py-2 px-5 bg-[#acb9a2] hover:bg-[#fb693c] rounded-lg text-white font-bold"
                    type="submit"
                  >
                    Sign In
                  </button>
                  ...
                  <button
                    className="py-2 px-5 border border-[#acb9a2] text-[#fb693c] hover:text-[#acb9a2] hover:border-[#fb693c] rounded-lg font-bold"
                    type="submit"
                  >
                    Sign Up
                  </button>
