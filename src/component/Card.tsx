...
const RecipeCard: FC<any> = (props) => {
  const { isEven = false, imgUrl, description, ...rest } = props;
  return (
    <div>
      <a href={`/recipes/${rest?._id}`} target="_blank">
        <div
        ...
        >
          ...
          <div
            className={`p-3 h-24 flex justify-center items-center cursor-pointer`}
          >
